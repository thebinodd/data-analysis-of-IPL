    ...
    <div>
        ...
        <header className="flex lg:max-w-[60vw] mt-10 w-[90vw] items-center justify-between rounded-xl border-4 border-neutral-950 bg-white px-4 py-3 shadow-[6px_6px_0_0_#111827] sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div className={!isHome ? 'flex-col flex' : 'flex-col hidden md:flex lg:flex'}>
...

          {
            isHome ? <nav className="flex items-center gap-2 md:flex">
              ...
              <Link className="rounded-lg border-2 border-neutral-950 bg-yellow-300 px-4 py-2 text-sm font-semibold shadow-[3px_3px_0_0_#111827] transition hover:translate-x-px hover:translate-y-px hover:shadow-none" href="https://github.com/thebinodd" target="_blank">
              Facts
            </Link>
            ...
            <Link className="rounded-lg border-2 border-neutral-950 bg-yellow-300 px-6 py-2 text-sm font-semibold shadow-[3px_3px_0_0_#111827] transition hover:translate-x-px hover:translate-y-px hover:shadow-none" href="/" >
              Home
            </Link>
